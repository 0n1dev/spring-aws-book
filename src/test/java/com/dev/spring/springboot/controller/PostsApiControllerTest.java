package com.dev.spring.springboot.controller;
...
public class PostsApiControllerTest {
    ...
    public void Posts_등록() throws Exception {
        ...
        PostsSaveRequestDto requestDto = PostsSaveRequestDto.builder().title(title).content(content).author("0n1dev").build();
